 ...
 */
final class Version20220430002307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bien (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(50) NOT NULL, nbrepieces INT NOT NULL, surface INT NOT NULL, prix INT NOT NULL, localisation VARCHAR(100) NOT NULL, type VARCHAR(15) NOT NULL, etage INT NOT NULL, transactiontype VARCHAR(10) NOT NULL, description VARCHAR(100) NOT NULL, dateconstruction DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
